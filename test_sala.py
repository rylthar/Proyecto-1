...
class TestSalaCRUD:
    ...
    def test_crear_sala_valida(self):
        ...
        Cuando envío una petición POST a /salas
    ...
    def test_obtener_todas_las_salas(self):
        ...
        Cuando envío una petición GET a /salas con limit=10
        ...
        response = client.get("/salas?skip=0&limit=10")
    ...
    def test_eliminar_sala(self):
        ...
        Dado que existe una sala con ID 1
        Cuando envío una petición DELETE a /salas/1
    ...
    def test_validacion_parametros_paginacion(self):
        ...
        # Limit < 1
        response = client.get("/salas?limit=0")
        assert response.status_code == 422
